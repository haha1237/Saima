...
adb shell "AudioSetParam vendor.a2dp.streamout.pcm=0"
adb shell "AudioSetParam vendor.aaudio.pcm=0"
adb shell "AudioSetParam vendor.af.effect.pcm=0"
adb shell "AudioSetParam vendor.af.mixer.drc.pcm=0"
adb shell "AudioSetParam vendor.af.mixer.end.pcm=0"
adb shell "AudioSetParam vendor.af.mixer.pcm=0"
adb shell "AudioSetParam vendor.af.offload.write.raw=0"
adb shell "AudioSetParam vendor.af.record.dump.pcm=0"
adb shell "AudioSetParam vendor.af.resampler.pcm=0"
adb shell "AudioSetParam vendor.af.track.pcm=0"
adb shell "AudioSetParam vendor.streamin.dsp.dump=0"
adb shell "AudioSetParam vendor.streamin.pcm.dump=0"
adb shell "AudioSetParam vendor.streamout.dsp.dump=0"
adb shell "AudioSetParam vendor.streamout.pcm.dump=0"
adb shell "AudioSetParam persist.vendor.audiohal.aurisys.pcm_dump_on=0"

echo stop audio_dump over

adb shell audiotest copyAudioDump

echo press press copy to SDCard key to move HAL dump
